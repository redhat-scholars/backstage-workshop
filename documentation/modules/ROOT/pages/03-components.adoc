...
On the Deployment Detail page, click on the Pods tab to find a list of Pod resources that are attached to this Deployment. If there are no pods, you may need to wait for your Pipeline Build to finish first.
...
In the next chapter, we will complete our Golden Path by using OpenShift DevSpaces to make a simple code contribution.
