...
Select the file `/src/main/java/com/rhdevelopers/summit/workshop/DemoBackendResource.java` in the left-hand file tree. Delete the comment markers (`/&ast;` and `&ast;/`) on line 73 and line 82 to enable the block of code they surround:
