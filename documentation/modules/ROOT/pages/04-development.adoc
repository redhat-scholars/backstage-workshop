...
Select the file `/src/main/java/com/rhdevelopers/summit/workshop/SummitBackendResource.java` in the left-hand file tree. Uncomment the following code block on lines 72 to 81:
...
This block of code is near the bottom of the file:
