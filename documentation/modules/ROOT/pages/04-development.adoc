...
In this chapter you will use DevSpaces to introduce a new API endpoint to your Gateway component.  The goal will be to add a custom datapoint to the "Red Hat Summit POI" dataset, which is stored in-memory within the Gateway component.
...
Make sure to click on *`Grant`* next to the **Summit23DevRHEL** GitHub Org before approving DevSpaces access
...
After DevSpaces has loaded your workspace, select "Yes, I trust the authors" to open the code editor
