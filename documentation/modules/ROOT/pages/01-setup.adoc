...
When logged in to GitHub with an invited account, you'll see a button on the [Workshop GitHub Org home page][URL] to accept the invite and join the Org directly.
