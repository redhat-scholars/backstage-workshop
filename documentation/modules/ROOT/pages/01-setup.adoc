...
You will need to create an OpenShift _Project_ for your exclusive use. Projects are a superset of the base Kubernetes _namespace_, and isolate resource names and access rights from other Projects on the cluster. Your OpenShift user and Project names should both match the GitHub ID you used to log in.

image::project_create.png[]

image::project_list.png[]

TIP: If you do not find a project, try refreshing your browser to reload the Projects pulldown menu.
...
Click on the waffle icon in the OpenShift Web Console header menu and select "Red Hat Developer Hub". 
