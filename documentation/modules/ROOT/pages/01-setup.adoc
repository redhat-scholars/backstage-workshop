...
In the next section, we will learn how to populate this project namespace with fresh content from the Backstage catalog. But first, let's connect to Backstage.
