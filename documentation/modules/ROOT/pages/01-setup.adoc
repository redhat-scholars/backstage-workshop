...
TIP: If you do not find a project, try reloading your browser to check again

IMPORTANT: Remember your Project names! You will need enter it into the Template forms as your *<Namespace>* value as you deploy components in the next two chapters.
