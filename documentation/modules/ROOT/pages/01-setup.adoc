...
Hate waiting and searching for email? When logged in to GitHub with an invited account, you'll see a button on the https://github.com/Summit23JanusN[Workshop GitHub Org home page] to accept the invite and join the Org.
